...
KANGING_STR = [
    "Using Witchery to kidnap this sticker...",
    "Plagiarising hehe...",
    "Inviting this sticker over to my pack...",
    "Cloning this sticker...",
    "Hey that's a nice sticker!\nMind if I kang?!..",
    "hehe me stel ur stikér\nhehe.",
    "Ay look over there (☉｡☉)!→\nWhile I take this...",
    "Roses are red violets are blue, taking this sticker so my pacc looks cool",
...
async def kang(args):
    ...
    if photo:
        ...
        await args.edit(f"`Sticker Kidnapped successfully!`\
